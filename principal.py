...
som_d = pygame.mixer.Sound('lm_inventory-close.wav')
som_e = pygame.mixer.Sound('smb2_bonus_chance_start.wav')
som_f = pygame.mixer.Sound('smw_pause.wav')
som_g = pygame.mixer.Sound('smw_message_block.wav')
som_h = pygame.mixer.Sound('smsunshine_shine_appears.wav')
som_j = pygame.mixer.Sound('lm_mario_yoo-hoo.wav')
som_k = pygame.mixer.Sound('mk64_mario01.wav')


aula = os.path.dirname(__file__)
telas = os.path.join ('novo\menu.png')
como_jogar = os.path.join(aula, 'novo\instrucoes.png')
tela_jogar = os.path.join (aula, 'avançado\portas_sem_pontuacao.png')
tela_jogar2 = os.path.join (aula, 'novo/2.png')
...
tela_inicial = os.path.join(aula, 'novo\menu.png')
tela_inicial2 = os.path.join(aula, 'novo\menu.png')
tela_musica = os.path.join(aula, 'tela_musica.png')
tela_preta1 = os.path.join(aula, 'tela_preta1.png')
tela_preta11 = os.path.join(aula, 'tela_preta1.png')
tela_preta2 = os.path.join(aula, 'tela_preta2.png')
tela_preta3 = os.path.join(aula, 'tela_preta3.png')
tela_preta4 = os.path.join(aula, 'tela_preta4.png')
tela_preta5 = os.path.join(aula, 'tela_preta5.png')
tela_preta6 = os.path.join(aula, 'tela_preta6.png')
tela_preta7 = os.path.join(aula, 'tela_preta7.png')
mapa_mental = os.path.join(aula, 'mapa_mental.png')
pergunta1 = os.path.join(aula, 'perg1.png')
erro = os.path.join(aula, 'erro.png')
erro2 = os.path.join(aula, 'erro2.png')
erro3 = os.path.join(aula, 'erro3.png')
erro4 = os.path.join(aula, 'erro4.png')
erro5 = os.path.join(aula, 'erro5.png')
acerto = os.path.join(aula, 'acerto.png')
acerto2 = os.path.join(aula, 'acerto2.png')
acerto3 = os.path.join(aula, 'acerto3.png')
acerto4 = os.path.join(aula, 'acerto4.png')
acerto5 = os.path.join(aula, 'acerto5.png')
dica1 = os.path.join(aula, 'dica1.png')
tabela = os.path.join(aula, 'tabelaperiodica.png')
proxima = os.path.join(aula, 'proxima.png')
perg2 = os.path.join(aula, 'perg2.png')
dica2 = os.path.join(aula, 'dica2.png')
perg3 = os.path.join(aula, 'perg3.png')
dica3= os.path.join(aula, 'dica3.png')
perg4= os.path.join(aula, 'perg4.png')
dica4= os.path.join(aula, 'dica4.png')
perg5= os.path.join(aula, 'perg5.png')
chave_interm= os.path.join(aula, 'nivel_interm_chave.png')
passar_nivel= os.path.join(aula, 'passar_nivel.png')
...
chave_bas = os.path.join(aula, 'BASICO\CHAVE_BASICO.png')

######################################################################################
#imagens intermediario
...
premio_nobel_ava = os.path.join(aula, 'avançado\premio_nobel_avançado.png')
...
#fimbas
                ...
                if mouse_x > x025 and mouse_y > y025 and mouse_x < x125 and mouse_y < y125:
                    fundo = pygame.image.load(port_bas)
                    tela_ativa = 4
